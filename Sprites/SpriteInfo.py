...
# Creating Ally Knight SpriteSheet
     global AllyKnightSpritesheet
     AllyKnightSpritesheet = SS.Spritesheet(pygame.image.load("Assets/CharacterSprites/Player/AllyKnightSpritesheet.png").convert_alpha(), 32)

# Creating Enemy Knight Sprite
     global EnemyKnightSpritesheet
     EnemyKnightSpritesheet = SS.Spritesheet(pygame.image.load("Assets/CharacterSprites/Enemy/EnemyKnightSpritesheet.png").convert_alpha(), 32)
