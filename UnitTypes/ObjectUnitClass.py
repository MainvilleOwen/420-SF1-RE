...
class ObjectUnit(Unit):
    def __init__(self, name:str, spritesheet:object, spriteIndex:int, reach:int, power:int, countdown:int, team:int):
        super().__init__(name, spritesheet, spriteIndex, reach, power, team)
