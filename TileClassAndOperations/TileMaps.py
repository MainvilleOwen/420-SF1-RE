...
# The cool part is because pygame has the origin of the screen at the top left corner and going up in y is down on the screen, this basically matches the list idndexes with [y][x]
        ...
        tileMap1 = TC.TileMap([[[None, None, None, None, None, None, None, None, None, None, None, None, None, None],
                                ...
                                [None, None, None, None, None, RG(), Wr(), FG(), RG(), RG(), DS(), None, None, None],
                                [None, None, None, FG(), FG(), FG(), Wr(), Wr(), FG(), FG(), DS(), DS(), None, None],
                                [None, FG(), FG(), FG(), FG(), FG(), Wr(), Wr(), FG(), FG(), FG(), DS(), None, None],
                                [None, FG(), FG(), FG(), FG(), Wr(), Wr(), Wr(), FG(), FG(), FG(), DS(), DS(), None],
                                [None, None, None, FG(), FN(), Wr(), Wr(), Wr(), FG(), FG(), FG(), DS(), DS(), None],
                                [None, None, None, FG(), FG(), Wr(), Wr(), Wr(), FG(), FG(), FG(), FG(), DS(), DS()],
                                [None, None, None, None, RG(), Wr(), Wr(), RG(), FG(), None, None, FG(), RG(), DS()],
                               ...
                               [[None, None, None, None, None, None, None, None, None, None, None, None, None, None],
                                ...
                                [RG(), FG(), None, None, None, None, None, None, None, None, None, None, DS(), None],
                                [None, FG(), FG(), None, RG(), FG(), None, None, None, None, None, None, None, DS()],
                                [None, FG(), FG(), None, None, None, None, RG(), None, None, None, None, None, None],
                               ...
                               [[None, None, None, None, None, None, None, None, None, None, None, None, None, None],
                                ...
                                [RG(), None, None, None, None, RG(), RG(), None, None, None, None, None, None, None],
